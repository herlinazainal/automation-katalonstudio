...
WebUI.setText(findTestObject('Swaglabs/Dashboard/input_Checkout Your Information_lastName'), 'Clauvve')

WebUI.setText(findTestObject('Swaglabs/Dashboard/input_Checkout Your Information_postalCode'), '55180')
